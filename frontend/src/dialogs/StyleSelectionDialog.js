...
import {Dialog, DialogTitle, DialogContent, DialogActions,
    Button, List, ListItem, ListItemText, Typography} from '@mui/material';

class StyleSelectionDialog extends Component {
  render() {
    const { open, onClose, styles, onSelect } = this.props;
